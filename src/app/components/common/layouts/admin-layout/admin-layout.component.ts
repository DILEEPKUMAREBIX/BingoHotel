...
export class AdminLayoutComponent implements OnInit {
  ...
  constructor(
    ...
    public masterSrv: ApiserviceService,
  ...
  ngOnInit() {
    ...
    {
      if(loginData.data.logo)
      {
        this.logo = this.masterSrv.apiRoot+'/'+loginData.data.logo
        this.loginUser = loginData.data.name
      }
