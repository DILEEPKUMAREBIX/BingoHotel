...
export class DashboardComponent implements OnInit {
  ...
  */
  ...
  constructor(private masterService: ApiserviceService, private httpClient: HttpClient, public router: Router) { }
  ngOnInit() {
    this.viewStats();
    this.checkLogin()
  }
  ...
  viewStats() {
    this.httpClient.get(this.masterService.apiRoot+'/portal/stats')
    .subscribe(
      (data:any) => {
        console.log("Done");
        this.stats = data;
